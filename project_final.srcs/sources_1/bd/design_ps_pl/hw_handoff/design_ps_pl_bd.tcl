...
################################################################
# This is a generated script based on design: design_ps_pl
#
...
# source design_ps_pl_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# PL, count_bin, pwm_14bit
...
proc create_hier_cell_PS_BRAM { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_PS_BRAM() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net BRAM_PORTB_0_1 [get_bd_intf_pins BRAM_PORTB_0] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M01_AXI] [get_bd_intf_pins axi_smc/M01_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FCLK_CLK0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set PL_BRAM_read [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $PL_BRAM_read eq "" } {
  ...
  # Create instance: count_bin_0, and set properties
  set block_name count_bin
  set block_cell_name count_bin_0
  if { [catch {set count_bin_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $count_bin_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: pwm_14bit_0, and set properties
  set block_name pwm_14bit
  set block_cell_name pwm_14bit_0
  if { [catch {set pwm_14bit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pwm_14bit_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net PS_BRAM_M01_AXI [get_bd_intf_pins PS_BRAM/M01_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  ...
  connect_bd_net -net PL_BRAM_read_led_out [get_bd_ports data_led] [get_bd_pins PL_BRAM_read/led_out]
  connect_bd_net -net PL_BRAM_read_pwm_out [get_bd_pins PL_BRAM_read/pwm_out] [get_bd_pins pwm_14bit_0/duty_cycle_in]
  ...
  connect_bd_net -net clk_125MHz_0_1 [get_bd_ports sys_clk] [get_bd_pins PL_BRAM_read/clk_125MHz] [get_bd_pins PS_BRAM/BRAM_PORTB_0_clk] [get_bd_pins count_bin_0/clk] [get_bd_pins pwm_14bit_0/clk_125M_in]
  connect_bd_net -net count_bin_0_count [get_bd_pins PL_BRAM_read/toggle_in] [get_bd_pins count_bin_0/count]
  connect_bd_net -net ps_BRAM_PORTB_0_dout [get_bd_pins PL_BRAM_read/BRAM_PORTB_0_dout] [get_bd_pins PS_BRAM/BRAM_PORTB_0_dout]
  connect_bd_net -net pwm_14bit_0_pwm_out [get_bd_ports pwm_out] [get_bd_pins pwm_14bit_0/pwm_out]
  connect_bd_net -net pwm_enable_dout [get_bd_pins pwm_14bit_0/enable_in] [get_bd_pins pwm_enable/dout]
  connect_bd_net -net pwm_reset_dout [get_bd_pins pwm_14bit_0/reset_in] [get_bd_pins pwm_reset/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces PS_BRAM/processing_system7_0/Data] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] SEG_xadc_wiz_0_Reg
